...
QMap<QString,QStringList> Util::Uart_devicetype()
{
    ...
    map["lc-modbus"]<<"modbus通用驱动"<<"start>启始寄存器地址"<<"quantity>寄存器数量"<<"functionCode>功能码:1,2,3,4"<<"vtype>值类型:int16,long,long-inverse,float32,float3-4321,float32-inverse,float64,float64-inverse,coils线圈";
